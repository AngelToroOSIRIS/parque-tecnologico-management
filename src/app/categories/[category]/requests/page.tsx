    ...
    <>
      ...
      <main className="margin-header">
        ...
        <div className="w-[70%] mx-auto">
          ...
          <RequestCard name="Sebastian Valbuena" discount="70%" email="sebastuan.valbuena@escuelaing.edu.co" paid="100.000" phone={3029876543} price="90.000" status="Pendiente" />
