          ...
          <ul className="hidden lg:flex flex-col items-center justify-center font-medium lg:flex-row">
            ...
            <li>
              ...
              >
                ...
                <p className="ml-2">Aulas y Salones</p>
              </button>
            </li>
            <li>
              <button
              ...
              >
                ...
                <p className="ml-2">Sitios Deportivos</p>
              </button>
            </li>
            <li>
              <button
                onClick={() => router.push("/recreational")}
              ...
              >
                ...
                <p className="ml-2">Sitios Recreativos</p>
              </button>
            </li>
            <li>
              <button
              ...
              >
                ...
                <p className="ml-2">Sala de Juntas</p>
              </button>
            </li>
          </ul>
        <Menu />
